                ...
                <div class="row">
                    <hr style="border-top: 2px solid #4e6891;">
                        <div class="hinario-section-name" style="margin-left:14px;">
                            ...
                            <input type="text" name="section_secondary_{{ $hymnHinario->getSection()->id }}" value="@if (count($hymnHinario->getSection()->getSecondaryTranslations()) > 0){{ $hymnHinario->getSection()->getSecondaryTranslations()[0]->name }}@endif">
                        </div>
